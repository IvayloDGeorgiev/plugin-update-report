...
class Updater
{
    ...
    public function __construct()
    {
        ...
        if (defined('PLUGIN_UPDATE_REPORT_VERSION')) {
        ...
        $this->version       = '1.1';
        $this->cache_key     = 'plugin_update_report_updater';
    ...
    public function request()
    {
        ...
        if (false === $remote || ! $this->cache_allowed) {
            $remote = wp_remote_get('https://github.com/IvayloDGeorgiev/plugin-update-report/tree/main/json%20release/info-V1.1.json', [
                    'timeout' => 10,
                    'headers' => [
